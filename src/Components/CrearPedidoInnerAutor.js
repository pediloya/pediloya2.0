...
const CrearPedidoInnerAutor = ({ secondSelect }) => {
    ...
    return (
        <>
            ...
            <Row>
                <Form.Group as={Col} sm={12} md={6} className='formGroup withSuggestions'>
                    <OutsideClickHandler
                        onOutsideClick={() => {
                            setNameToggle(false)
                        }}
                        ...
                        <div className='inputAndSuggestions'>
                            ...
                            <div className={`suggestions names ${nameToggle ? 'show' : ''}`}>
                                ...
                                {!autors ? (
                                    <small>
                                        <em>
                                            Se guardará la información que completes para que la puedas utilizar en un próximo
                                            pedido
                                        </em>
                                    </small>
                                ) : (
